...
const WelcomeBanner =()=> {
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white rounded-lg shadow-2xl h-full relative overflow-hidden px-2 py-4 md:px-4 md:py-8 lg:py-12">
      <h1 className="text-4xl md:text-3xl lg:text-4xl text-center p-2 md:p-4 font-semibold bg-gradient-to-r from-yellow-300 to-blue-500 bg-clip-text text-transparent animate-pulse">
        Welcome to ProChesser Academy, Winny
      </h1>
