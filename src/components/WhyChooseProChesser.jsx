...
const WhyChooseProChesser = () => {
  return (
    <section className="bg-white w-screen py-16 px-6">
      <div className="container mx-auto">
        {/* Title */}
        <h2 className="text-3xl sm:text-4xl font-extrabold text-yellow-600 text-center mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="border-b border-r border-yellow-600 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
          ...
          {/* Feature 3 */}
          <div className="border-b border-yellow-600 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
          ...
          {/* Feature 7 */}
          <div className="border-r border-yellow-600 p-6 rounded-lg hover:shadow-lg transition-shadow duration-300">
