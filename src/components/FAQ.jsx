      ...
      <div className="container mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Absolutely! Free games are available if you want to practice or play for fun. These games have no money on the line, so it's all about the love of the game.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold text-gray-700 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Our support team can assist you 24/7 via live chat or email at support@prochesser.com.
            </p>
          </div>
        </div>
        </div>
