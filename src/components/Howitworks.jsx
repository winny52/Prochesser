        ...
        <div className="space-y-10">
          ...
          <div className="ml-6 md:ml-12 space-y-6  text-gray-700">
            <p className="text-lg hover:text-yellow-600 transition-colors duration-300">
              <span className="font-bold text-black">Option 1:</span> Create a game and copy its ID. Activate the game by clicking 'Start'. Share the ID with your friend to play together - equal stakes are necessary.
            </p>
            <p className="text-lg hover:text-yellow-600 transition-colors duration-300">
              <span className="font-bold text-black">Option 2:</span> Create a game with your chosen stake. Activate the game by clicking 'Start' and wait for an opponent within your skill range.
            </p>
            <p className="text-lg hover:text-yellow-600 transition-colors duration-300">
              <span className="font-bold text-black">Option 3:</span> Browse opponents in the game lobby by skill level or stakes, then join a game. Ensure your account balance matches the wager amount.
            </p>
          </div>
