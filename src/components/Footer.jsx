    ...
    <footer className="bg-white text-black py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
        ...
        <div>
          ...
          <ul>
            <li className="mb-2">
              <Link to="/classes" className="text-black">Sign Up for Classes</Link>
            </li>
            <li className="mb-2">
        ...
        <div>
          ...
          <p className="mb-2">Email: <a href="mailto:support@prochesser.com" className=" text-black hover:text-yellow-500">support@prochesser.com</a></p>
          <div className="mt-4">
