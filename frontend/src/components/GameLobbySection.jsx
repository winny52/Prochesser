    ...
    <section className="bg-black w-screen py-12 px-6 md:py-16 md:px-8">
      <div className="container mx-auto text-center max-w-screen-lg">
        ...
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed">
          Explore our diverse game lobby, where players of all levels find their
          match. Every game, from casual to ranked matches, is an opportunity to
          sharpen your skills and increase your earnings. Pick your challenge.
          Make your move.
        </p>

        {/* Button */}
        <a
          href={`${CHESS_GAME_APP_URL}/login`}
